...
async def _(client, message):
    ...
    sh = await message.reply("""<u><b>𝗙𝗜𝗧𝗨𝗥 𝗙𝗥𝗘𝗘 DAPA 𝗨𝗦𝗘𝗥𝗕𝗢𝗧!</b></u>
...
<b>ᴏᴡɴᴇʀ ᴜsᴇʀʙᴏᴛ: <a href=https://t.me/susudancow15>𝐨𝐰𝐧𝐞𝐫 𝐞𝐤𝐢𝐤𝐢𝐦𝐮𝐭</a></b></blockquote>""", reply_markup=InlineKeyboardMarkup(buttons))